...
func (c *randomClient) GetDate(ctx context.Context, in *RequestDateTime, opts ...grpc.CallOption) (*DateTime, error) {
	out := new(DateTime)
	err := c.cc.Invoke(ctx, Random_GetDate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *randomClient) GetRandom(ctx context.Context, in *RandomParams, opts ...grpc.CallOption) (*RandomInt, error) {
	out := new(RandomInt)
	err := c.cc.Invoke(ctx, Random_GetRandom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *randomClient) GetRandomPass(ctx context.Context, in *RequestPass, opts ...grpc.CallOption) (*RandomPass, error) {
	out := new(RandomPass)
	err := c.cc.Invoke(ctx, Random_GetRandomPass_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
